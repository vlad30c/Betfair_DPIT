                  ...
                  children: [
                    Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset(
                          'assets/images/bitemaiinchis.png',
                          width: 313.3,
                          height: 190.0,
                          fit: BoxFit.cover,
                        ),
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        _model.apiResultdz2 =
                            await AuthenticationGroup.logInCall.call(
                          username: _model.usernamefieldTextController.text,
                          email: _model.emailAddressTextController.text,
                          password: _model.passwordTextController.text,
                        );

                        if ((_model.apiResultdz2?.succeeded ?? true)) {
                          FFAppState().AuthKey = currentAuthenticationToken!;
                          safeSetState(() {});
