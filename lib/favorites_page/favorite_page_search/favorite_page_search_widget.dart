...
import 'favorite_page_search_model.dart';
export 'favorite_page_search_model.dart';

class FavoritePageSearchWidget extends StatefulWidget {
  const FavoritePageSearchWidget({super.key});

  static String routeName = 'Favorite_Page_Search';
  static String routePath = '/favoritePageSearch';

  @override
  State<FavoritePageSearchWidget> createState() =>
      _FavoritePageSearchWidgetState();
}

class _FavoritePageSearchWidgetState extends State<FavoritePageSearchWidget> {
  late FavoritePageSearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FavoritePageSearchModel());
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: InkWell(
            ...
            onTap: () async {
              context.pushNamed(
                FavoritePageFiltersWidget.routeName,
