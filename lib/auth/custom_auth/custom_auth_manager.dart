...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    biteAuthUserSubject.add(
      BiteAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<BiteAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  BiteAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = BiteAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    biteAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
