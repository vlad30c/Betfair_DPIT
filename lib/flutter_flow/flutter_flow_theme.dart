...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF230C33);
  late Color alternate = const Color(0xFFD7B2E6);
  late Color primaryText = const Color(0xFFEDE6F0);
  late Color secondaryText = const Color(0xFFD7B2E6);
  late Color primaryBackground = const Color(0xFF1D2428);
  late Color secondaryBackground = const Color(0xFF14181B);
  late Color accent1 = const Color(0xFFA369CB);
  late Color accent2 = const Color(0xC9BA79DA);
  late Color accent3 = const Color(0xC9D771FF);
  late Color accent4 = const Color(0xFFD9C8E2);
  late Color success = const Color(0xFF03614D);
  late Color warning = const Color(0xFFDFB643);
  late Color error = const Color(0xFF6C0102);
  late Color info = const Color(0xFF073B67);
