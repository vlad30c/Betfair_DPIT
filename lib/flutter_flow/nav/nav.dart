...
class AppStateNotifier extends ChangeNotifier {
  ...
  void update(BiteAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: FavoriteMainPageWidget.routeName,
          path: FavoriteMainPageWidget.routePath,
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Favorite_Main_Page')
              : FavoriteMainPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: ProfileSupportWidget.routeName,
          path: ProfileSupportWidget.routePath,
          requireAuth: true,
          builder: (context, params) => ProfileSupportWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: RestaurantInterfaceAWidget.routePath,
          requireAuth: true,
